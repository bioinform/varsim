...
rand_vcf_group.add_argument("--som_max_length_lim", metavar="max_length_lim", help="Max length lim", default=50, type=int)
...
varsim_command = ["python", os.path.realpath(args.varsim_py.name), 
                  ...
                  "--vcf2diploid_jar", str(os.path.realpath(args.vcf2diploid_jar)), 
                  ...
                  "--liftover_jar", str(os.path.realpath(args.liftover_jar)), 
                  "--vcfstats_jar", str(os.path.realpath(args.vcfstats_jar)), 
                  "--disable_sim", str(args.disable_sim), 

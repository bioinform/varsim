...
public class VCFcompare {
    ...
    @Option(name = "-reference", usage = "Reference Genome, specificity will be computed if provided", metaVar = "file", required = true)
    String reference;
    ...
    public void run(String[] args) {
        ...
        outputBlob.getParams().setBed_filename(bed_filename);
        // TODO: make it output the full list if variants in JSON
        outputBlob.getParams().setNew_vcf_filename(new_vcf_filename.get(0));
        outputBlob.getParams().setOverlap_percent(overlap_ratio);
        outputBlob.getParams().setTrue_vcf_filename(true_vcf_filename);
